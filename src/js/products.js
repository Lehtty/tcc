const products = [
  {
    ...
    old: 129.90,
    badge: 'Sale',
    colors: ['#2c2c2a', '#c4705a', '#80a080', '#fff'],
    colorsName: ['Preto Editorial', 'Laranja Classic', 'Verde Oliva', 'Branco Clássico'],
    sizes: ['P', 'M', 'G', 'GG'],
    category: 'Feminino',
